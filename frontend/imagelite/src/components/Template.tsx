...
const Loading: React.FC = () => {
    return (
        <div role="status">
            <svg data-cy="iconLoading" aria-hidden="true" className="inline w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        <header className="bg-indigo-950 text-white py-3">
            <div className="container mx-auto flex justify-between items-center px-4">
                <Link href="/galeria">
                    <h1 className="text-3x1">Image Lite</h1>
                </Link>
                <RenderIf condition={!!user}>
                    <div className="flex items-center">
                        <div className="relative">
                            ...
                            <span className="w-64 py-3 px-6 text-md"><a href="#" onClick={logout}>Logout</a></span>
                        </div>
                    </div>
    ...
    return (
        <footer className="bg-indigo-950 text-white py-4 mt-8">
            <div className="container mx-auto text-center">
                Desenvolvido por Nelson Mendes
            </div>
        </footer>
    );
};